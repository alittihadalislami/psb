...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">T_wali <?php echo $button ?></h2>
	    ...
	    <div class="form-group">
            <label for="varchar">Tra Tri <?php echo form_error('tra_tri') ?></label>
            <input type="text" class="form-control" name="tra_tri" id="tra_tri" placeholder="Tra Tri" value="<?php echo $tra_tri; ?>" />
        </div>
	    <div class="form-group">
	    ...
	    <a href="<?php echo site_url('t_wali') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>